...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    startButton.frame=CGRectMake(60, 180, 120, 35);
...
-(void)alertUser{
    UIAlertView *alertView=[[UIAlertView alloc]initWithTitle:@"温馨提示" message:@"这是alert Level级别" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
}
